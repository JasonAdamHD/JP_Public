...
public class DBSelectMenu extends Activity
{
    GridView m_grid;
    SQLiteDBHelper m_db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_grid.setAdapter(new DBSelectAdapter(this, m_db.getAllImgs(), this)); //sets grid's adapter to dynamically add imagebuttons
    }
}